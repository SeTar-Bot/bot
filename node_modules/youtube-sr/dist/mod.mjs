import{createRequire as cr1646325907642}from"module";var require=cr1646325907642(import.meta.url);var __defProp = Object.defineProperty;
...
var Util = class {
  ...
  static parseChannel(data) {
    ...
    let res = new Channel_default({
      ...
      url,
      verified: Boolean((_b = (_a = badge == null ? void 0 : badge.metadataBadgeRenderer) == null ? void 0 : _a.style) == null ? void 0 : _b.toLowerCase().includes("verified")),
  ...
  static parseVideo(data) {
    ...
    let res = new Video_default({
      ...
      uploadedAt: (_d = (_c = data.videoRenderer.publishedTimeText) == null ? void 0 : _c.simpleText) != null ? _d : null,
      views: (_g = (_f = (_e = data.videoRenderer.viewCountText) == null ? void 0 : _e.simpleText) == null ? void 0 : _f.replace(/[^0-9]/g, "")) != null ? _g : 0
    });
    return res;
  }
